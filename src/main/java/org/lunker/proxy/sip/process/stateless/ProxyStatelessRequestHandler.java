...
//            addRecordRouteHeader(message);
            ...
            // => Move to @Link{org.lunker.new_proxy.sip.wrapper.message.DefaultSipMessage} send();
            determineNextHop(message);


            // 8)
            /*
                TODO: Move to @Link{org.lunker.new_proxy.sip.wrapper.message.DefaultSipMessage} send();
